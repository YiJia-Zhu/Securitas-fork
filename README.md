# Securitas: Flexible In-Network Traffic Obfuscation in NSDI '26

This repository contains the cleaned Web/WF open-source artifacts for the
NSDI '26 paper:
...
conda activate securitas-open-source
```
